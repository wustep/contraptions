...
async function main(): Promise<void> {
  ...
  check('the shows are Clair de Lune, Cornfield Chase, Interstellar and Première', shipped.works.map((w) => w.work).sort().join(',') === 'clair-de-lune,cornfield-chase,interstellar,premiere-arabesque')
