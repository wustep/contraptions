...
export const shelf: Shelf = additions(harbor, [
  ...
  [spyglass, 'restored', 'a brass spyglass on a stand lengthens across two cells of open water with the ball corked in its eyepiece, and lets it go on the far pier. Cut in #63, asked out by name; nothing took its cells, and Aqua went to thirty-four.'],
