...
export const shelf: Shelf = additions(garden, [
  ...
  [turf, 'restored', 'a roll of turf on a bed of bare soil: the ball thumps into it and it goes, unrolling ahead of the ball and laying lawn level with the path. Cut in #65, asked out by name; the web came back into the garden in its place.'],
