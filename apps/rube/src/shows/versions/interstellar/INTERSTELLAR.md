...
Every part is new: the pieces, the worlds, the palettes, the sky, and the camera. Nothing comes from Machine's worlds or from the other takes. The one thing shared with the earlier Opus 5.5 take is the onset file for Cornfield Chase, `scripts/shows/plans/cornfield-opus55-onsets.json`. That file is a measurement of the recording.
