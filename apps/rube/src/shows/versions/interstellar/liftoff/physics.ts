...
/**
 * Gravity, in cells a second a second. A cell is about a metre on the farm,
 * so the farm's is nearly the real thing; the dark's is a quarter of it,
 * which is what makes a flight there hang.
 */
