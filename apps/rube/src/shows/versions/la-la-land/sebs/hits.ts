 ...
 */
const modules: Record<string, Record<string, unknown>> = { opening, finale, kiss, theatre, studio, hollywood, shadow, globe, jazz, trumpet, painted, stars, movie, drive, city, transitions }
