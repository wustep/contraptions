...
/**
 * Gravity, in cells a second a second. A cell is about a foot in the laundromat, so home's is a little under the
 * real thing; the dark round the bagel has almost none, which is what makes a drift there hang.
 */
export const G = 12
