...
and check:shows holds them against. Rerun only if the mix changes:
    ...
    python3 scripts/shows/liftoff-ntfc-onsets.py
...
MIX = os.path.join(ROOT, 'apps/rube/src/shows/versions/interstellar/interstellar-liftoff-mix-demo.mp3')
OUT = os.path.join(ROOT, 'scripts/shows/plans/liftoff-ntfc-onsets.json')
SR = 22050
HOP = 256
N = 2048
...
def main():
    ...
    out = {
        'source': 'apps/rube/src/shows/versions/interstellar/interstellar-liftoff-mix-demo.mp3',
        'cue': 'https://www.youtube.com/watch?v=kpK4cDk2bRs',
