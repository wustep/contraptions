...
The show plays docs/promo/lalaland-epilogue-demo.mp3 (demo only; see
docs/promo/LALALAND_EPILOGUE_ATTRIBUTION.txt). This reads it and writes
scripts/show-plans/lalaland-epilogue-onsets.json, which the parts are timed
to and check:shows holds them against. Rerun only if the recording changes:

    python3 scripts/lalaland-epilogue-onsets.py
...
MP3 = os.path.join(ROOT, 'docs/promo/lalaland-epilogue-demo.mp3')
OUT = os.path.join(ROOT, 'scripts/show-plans/lalaland-epilogue-onsets.json')
SR = 22050
N = 2048
...
def main():
    ...
    out = {
        'source': 'docs/promo/lalaland-epilogue-demo.mp3',
