...
so the file can be played end to start without a seam.
    ...
    python3 scripts/satie-render.py <mutopia dir> <salamander dir>

writes

- docs/promo/satie-gymnopedie.mp3: the period, with MARGIN seconds of its own
...
- scripts/show-plans/satie-performance.json: every note as it was played, in
...
OUT_AUDIO = os.path.join(ROOT, 'docs/promo/satie-gymnopedie.mp3')
OUT_PLAN = os.path.join(ROOT, 'scripts/show-plans/satie-performance.json')
MARGIN = 2.0
...
def main():
    ...
    plan = {
        'about': 'Satie, played for the Gymnopédie show by scripts/satie-render.py. Show seconds; the file is docs/promo/satie-gymnopedie.mp3, whose show zero is at `margin`.',
        'period': period,
        'margin': MARGIN,
        'pieces': pieces,
